...
//             style={{ position: "relative", height: "calc(100% - 78px)", gap: "20px" }}
//           >
//             <div
//               className="fit-container fx-scattered fx-col fx-start-h fx-start-v"
...
//                       <div className="fx-centered" style={{ gap: "3px" }}>
//                         <RelayImage url={protectedRelay} size={16} />
//                         <span>{protectedRelay}</span>
//                       </div>
//                     </div>
//                     <div
//                       className="close"
//                       style={{ position: "static", scale: "0.8" }}
//                     >
//                       <div></div>
//                     </div>
//                   </div>
...
//                 style={{ position: "relative", maxHeight: protectedRelay ? "90%" : "100%"}}
//               >
//                 <textarea
//                   type="text"
//                   style={{
...
//               </div>
//             </div>
//             {/* <div className="fit-container fx-scattered fx-col box-pad-h-s box-pad-v-s sc-s-18 bg-sp">
//               <div className="fx-scattered fx  fit-container">
//                 <div className="box-pad-h-s">
//                   <p>{t("AfkY3WI")}</p>
//                   <p className="p-medium gray-c">{t("A0EIM4m")}</p>
//                 </div>
//                 <Toggle status={isPaid} setStatus={setIsPaid} />
//               </div>
//               {protectedRelay && (
//                 <div className="fx-scattered fx fit-container">
//                   <div className="box-pad-h-s">
//                     <p className="p-medium gray-c">{t("A0qEczF")}</p>
//                     <p>{protectedRelay}</p>
//                   </div>
//                   <Toggle status={isPaid} setStatus={setIsPaid} />
//                 </div>
...
//               {exit && (
//                 <button
//                   className="btn btn-gst btn-normal"
//                   disabled={isLoading}
//                   onClick={() => (note ? setShowWarningBox(true) : exit())}
//                 >
//                   {isLoading ? <LoadingDots /> : t("AB4BSCe")}
...
//               )}
//               <button
//                 className="btn btn-normal btn-normal"
//                 onClick={publishNote}
//                 disabled={isLoading}
//               >
//                 {isLoading ? (
