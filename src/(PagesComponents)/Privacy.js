      ...
      <div style={{ width: "min(100%, 1000px)" }}>
        ...
        >
          ...
          <ul className="fx-centered fx-col fx-start-h fx-start-v">
            ...
            <li>
              <p>
                <strong>Application</strong> refers to YakiHonne, the software
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to JustHonne
                technology SDN BHD, 80 DM01 FLR 2, JLN 1/76D, DESA PANDAN, KUALA
                LUMPUR.
              </p>
            </li>
            <li>
